# 10. Write a function that reads a file file1 and copies only 
# alternative lines to another file file2. Alternative lines copied
#  should be the odd numbered lines.
