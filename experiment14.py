# 14. Take as input in the months and profits made by a company ABC over a year. 
# Represent this data using a line plot. Generated line plot must 
# include X axis label name = Month Number and Y axis label name = Total profit.
