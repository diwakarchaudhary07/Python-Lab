# 6. Write a program that accepts two strings and returns
#  the indices of all the occurrences of the second string in the
#  first string as a list. If the second string is not present in the first string,
